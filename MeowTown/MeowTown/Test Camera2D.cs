...
namespace MeowTown
{
    public class Camera2DDDDD
    {
        ...
        protected static Camera2DDDDD _cam;
        protected static Viewport _view;

        public Camera2DDDDD(Viewport viewport)
        {
            _zoom = 1.0f;
            _scroll = 1;
            _rotation = 0.0f;
        ...
        //=================================
        public static Viewport ViewingPort
        {
            get { return _view; }
            set { ;}
        }
        public static Camera2DDDDD Camera
        {
            get { return _cam = new Camera2DDDDD(ViewingPort);;}
        }
    }
}
